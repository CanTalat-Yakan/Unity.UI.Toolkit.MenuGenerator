...
namespace UnityEssentials
{
    ...
    public class MenuEditorUtilities : MonoBehaviour
    {
        public static void PopulateDataFromTree(MenuData data, SimpleTreeView treeView)
        {
        ...
        public static SimpleTreeViewItem CreateItem(ScriptableObject data, SimpleTreeView treeView, SimpleTreeViewItem parent = null) =>
            data switch
            {
                MenuCategoryData categoryData => CreateItemRecursive(CreateCategory(treeView, categoryData.Name), categoryData, treeView, parent),
                MenuHeaderData headerData => CreateItemRecursive(CreateHeader(treeView, headerData.Name), headerData, treeView, parent),
                MenuSpacerData spacerData => CreateItemRecursive(CreateSpace(), spacerData, treeView, parent),
                MenuButtonData buttonData => CreateItemRecursive(CreateButton(treeView, buttonData.Name), buttonData, treeView, parent),
                MenuOptionsData optionsData => CreateItemRecursive(CreateOptions(treeView, optionsData.Name), optionsData, treeView, parent),
                MenuInputData inputData => CreateItemRecursive(CreateInput(treeView, inputData.Name), inputData, treeView, parent),
                MenuSliderData sliderData => CreateItemRecursive(CreateSlider(treeView, sliderData.Name), sliderData, treeView, parent),
                MenuToggleData toggleData => CreateItemRecursive(CreateToggle(treeView, toggleData.Name), toggleData, treeView, parent),
                MenuSelectionCategoryData selectionDataCategory => CreateItemRecursive(CreateSelectionCategory(treeView, selectionDataCategory.Name), selectionDataCategory, treeView, parent),
                MenuSelectionGroupData selectionDataGroup => CreateItemRecursive(CreateSelectionGroup(treeView, selectionDataGroup.Name), selectionDataGroup, treeView, parent),
                MenuColorPickerData colorPickerData => CreateItemRecursive(CreateColorPicker(treeView, colorPickerData.Name), colorPickerData, treeView, parent),
                MenuColorSliderData colorSliderData => CreateItemRecursive(CreateColorSlider(treeView, colorSliderData.Name), colorSliderData, treeView, parent),
                _ => null
            };
        ...
        public static SimpleTreeViewItem CreateCategory(SimpleTreeView treeView, string name = "Category") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuCategoryData>(name, uniqueName));
        ...
        public static SimpleTreeViewItem CreateHeader(SimpleTreeView treeView, string name = "Header") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuHeaderData>(name, uniqueName, hasReference: false));
        ...
        public static SimpleTreeViewItem CreateSpace() =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuSpacerData>(hasReference: false));
        ...
        public static SimpleTreeViewItem CreateButton(SimpleTreeView treeView, string name = "Button") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuButtonData>(name, uniqueName));
        ...
        public static SimpleTreeViewItem CreateOptions(SimpleTreeView treeView, string name = "Options") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuOptionsData>(name, uniqueName));
        ...
        public static SimpleTreeViewItem CreateInput(SimpleTreeView treeView, string name = "Input") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuInputData>(name, uniqueName));
        ...
        public static SimpleTreeViewItem CreateSlider(SimpleTreeView treeView, string name = "Slider") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuSliderData>(name, uniqueName));
        ...
        public static SimpleTreeViewItem CreateToggle(SimpleTreeView treeView, string name = "Toggle") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuToggleData>(name, uniqueName));
        ...
        private static Type[] SupportedTypes = { typeof(MenuHeaderData), typeof(MenuSpacerData),
              typeof(MenuSelectionGroupData), typeof(MenuColorSliderData), typeof(MenuColorPickerData) };
        public static SimpleTreeViewItem CreateSelectionCategory(SimpleTreeView treeView, string name = "Selection Category") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuSelectionCategoryData>(name, uniqueName, hasReference: false));
        ...
        public static SimpleTreeViewItem CreateSelectionGroup(SimpleTreeView treeView, string name = "Selection Group") =>
            new SimpleTreeViewItem()
                ...
                .SetContextMenu(GetGenericMenu(treeView))
                .SetUserTag(UIMenuDataTypes.Selection.ToString())
                .SetUserData(MenuTypeDataBase.Initialize<MenuSelectionGroupData>(name, uniqueName));
        ...
        public static SimpleTreeViewItem CreateColorPicker(SimpleTreeView treeView, string name = "Color Picker") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuColorPickerData>(name, uniqueName));
        ...
        public static SimpleTreeViewItem CreateColorSlider(SimpleTreeView treeView, string name = "Color Slider") =>
            new SimpleTreeViewItem()
                ...
                .SetUserData(MenuTypeDataBase.Initialize<MenuColorSliderData>(name, uniqueName));
    }
}
#endif